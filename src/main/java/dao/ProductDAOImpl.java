...
public class ProductDAOImpl implements ProductDAO {
	...
	public int addProduct(Product product) {
		try {
			ps = con.prepareStatement(
					"INSERT INTO product (id_category,name_product,description,price,old_price,image) Values (?,?,?,?,?,?)");
	...
	public int updateProduct(Product product) {
		try {
			ps = con.prepareStatement(
					"update product set id_category=?, name_product=?, description=?, price=?, old_price=?, image=?"
							+ "where id_product=?");
