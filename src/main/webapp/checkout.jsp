                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="command" class="checkout" method="get" name="checkout">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" value="<%= u.getFname() %>" placeholder="" id="billing_first_name" name="billing_first_name" class="input-text " required>
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Last Name <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="<%= u.getLname() %>" placeholder="" id="billing_last_name" name="billing_last_name" class="input-text " required>
                                            </p>
                                            <div class="clear"></div>
                                            ...
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <input type="text" value="<%= u.getAddress() %>" placeholder="Street address" id="billing_address_1" name="billing_address_1" class="input-text " required>
                                            </p>
                                            ...
                                            <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                ...
                                                %>
                                                <input type="text" value="<%= u.getCity() %>" placeholder="Town / City" id="billing_city" name="billing_city" class="input-text " required>
                                            </p>
                                            ...
                                            <p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
                                                ...
                                                %>
                                                <input type="text" id="billing_state" name="billing_state" placeholder="State / County" value="<%= u.getState() %>" class="input-text " required>
                                            </p>
                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                <label class="" for="billing_postcode">Postcode <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <%  
                                                if(u.getPostecode() == null) {
                                                ...
                                                %>
                                                <input type="text" value="<%= u.getPostecode() %>" placeholder="Postcode / Zip" id="billing_postcode" name="billing_postcode" class="input-text " required>
                                            </p>
                                            ...
                                            <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                ...
                                                <input type="text" value="<%= u.getEmail() %>" placeholder="" id="billing_email" name="billing_email" class="input-text " required>
                                            </p>
                                            ...
                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                ...
                                                %>
                                                <input type="text" value="<%= u.getPhone() %>" placeholder="" id="billing_phone" name="billing_phone" class="input-text " required>
                                            </p>
                                            <div class="clear"></div>
                                    ...
                                    <table class="shop_table">
		     							...
		     							%>
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    <%= p.getProductName() %> <strong class="product-quantity">× <%= ci.getQty() %></strong> </td>
                                                <td class="product-total">
                                                    <span class="amount"><%= p.getPrice()%></span> </td>
                                            </tr>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount"><%= c.getTotal() %></span></strong> </td>
                                            </tr>
